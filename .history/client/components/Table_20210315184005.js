...
export default class Table extends React.Component{
      ...
      checkAllBoxes(){
            ...
            const classNames = ['checkbox', 'addedcheckbox']
            const che = []
          if ( classNames.some(className => document.classList.constains(className))) che.push()
            console.log(che)
            // const checkboxes = [...document.getElementsByClassName('checkbox')]
            console.log('this is checkedboxes', checkboxes)
