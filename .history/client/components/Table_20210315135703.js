...
export default class Table extends React.Component{
      ...
      getHeader(){
            ...
            const checkboxHeader = document.createElement("input").setAttribute("type", "checkbox");
            checkboxHeader
           const tableHeader = headers.map((info, index) => <th key={index} className='header'>{info.toUpperCase()}</th>)
      //      if(document.getElementById('head'))document.getElementById('head').appendChild(checkboxHeader)
           //
           return tableHeader
      }
      getRow(){
