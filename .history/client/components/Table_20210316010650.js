            ...
            if(!this.state.isLoading){
                  ...
                  return(  
                        <div>
                              ...
                              <div id='amountRows'><p id='totalRow'>Total Row Count:{this.state.numbersRow}</p> <p id='totalchecked'>Total Checked Row: {this.state.checkedBalance.length}</p></div>
                              <div id= 'total'><p>T <span>${this.getDataBalance()}</span></p></div>
