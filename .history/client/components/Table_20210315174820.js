...
export default class Table extends React.Component{
      ...
      checkAllBoxes(){
            ...
            allCheckbox.addEventListener('click', (event)=>{
                  ...
                  const checkedBalance = checkboxes.map(box => {
                        if(box.checked) return box.value
                  })
                  this.setState({
                        checkedBalance
                  })
                  console.log('this is allcheckbox', this.state.checkedBalance)
            })
      ...
      checkSingleBox(){
            ...
            const checkedBalance = boxes.filter(box => box.checked).map(box => )
            this.setState({
                  checkedBalance
            })
