...
export default class Table extends React.Component{
      ...
      checkSingleBox(){
            // 
            const checkboxes = this.state.checkboxes.filter(box => box.checked)
            this.setState({checkboxes:this.state.checkboxes.filter(box => box.checked) })
            const checkedBalance = this.state.checkboxes.filter(box => box.checked).map(box => box.value)
            console.log('checkbalance',this.state.checkboxes.filter(box => box.checked).map(box => box.value))
            this.setState({checkedBalance: this.state.checkboxes.filter(box => box.checked).map(box => box.value) })
            console.log('checkbalance', this.state.checkedBalance)
            console.log('this is state checkboxes', this.state.checkboxes)
            console.log('ths is checkboxes', this.state.checkboxes.filter(box => box.checked))
