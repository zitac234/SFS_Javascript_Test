...
export default class Table extends React.Component{
      ...
      addBalance(){
            let addedRowBalance = 0
           const dataBalance =  this.state.data.reduce( ( sum, { balance} ) => sum + balance , 0)  
           if([ ...table.rows].slice(10)){

           }
            return (dataBalance + addedRowBalance)
            // console.log('this is rows',[ ...table.rows].slice())
            //  to get balance  from rows into a row
      ...
      addRow(){
            ...
            for(let i = 0; i < 5; i++){
                  ...
                  txtInput.type = 'text'
                  if(i === 4) txtInput.className += 'added'
