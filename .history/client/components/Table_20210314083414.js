...
export default class Table extends React.Component{
      ...
      async componentDidMount(){ 
            ...
            // const  dataBalance = [...document.getElementsByClassName('dataBalance')]
            // this.setState({
            //       dataBalance 
            // })
            // if(document.getElementById('table'))console.log(dataBalance )
      ...
      deleteRow(){
            ...
            console.log(document.getElementsByClassName('dataBalance'))
            if(this.state.addedBalance.length === 0){
                  // this.removeData(index-1)
            }
            // slice the last number out
      }
      removeData(num){
            const newData = this.state.data.filter(info => info.id !== num)
            console.log(newData)
            // this.setState({
            //       data: newData
            // })
