...
export default class Table extends React.Component{
      ...
      checkAllBoxes(){
            ...
            const checkboxes = [...document.querySelectorAll('.allCheckbox, .addedcheckbox')]
      ...
      checkSingleBox(){
            document.querySelectorAll('.allCheckbox, .addedcheckbox')
            let boxes = [...document.getElementById('allCheckbox, addedcheckbox')]
