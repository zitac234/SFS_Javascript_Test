...
export default class Table extends React.Component{
      ...
      deleteRow(){
          ...
          console.log( [...cell.querySelectorAll(".checkbox, .addedcheckbox")].length > 0)
           if(cell.querySelectorAll(".checkbox, .addedcheckbox")){
                 deleteBalance = cell.children[0]
                 console.log(deleteBalance)
            }else{
                  deleteBalance = table.rows[index].cells[5]
                  console.log(deleteBalance )
            }
