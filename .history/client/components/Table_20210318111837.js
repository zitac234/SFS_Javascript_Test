...
export default class Table extends React.Component{
      ...
      deleteRow(){
           ...
           if(Number(this.state.checkedBalance[lastIndex].replace(',', '')) === Number(deleteBalance.replace(',', ''))) { 
            ...
            console.log('this is state checked balance', this.state.checkedBalance)
      ...
      checkSingleBox(){
            console.log('this is state before', this.state.checkedBalance)
            const checkedBalance = this.state.checkboxes.filter(box => box.checked).map(box => box.value)
            this.setState({checkedBalance})
            console.log('this is stateafter ', this.state.checkedBalance)
      }
      getRow(){
